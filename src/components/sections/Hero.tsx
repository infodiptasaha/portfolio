...
export function HeroSection() {
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-20 md:py-24 text-center text-white flex flex-col items-center justify-center min-h-screen">
        {/* Status badge */}
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-xs md:text-sm font-medium mb-6">
          <span className="w-2 h-2 rounded-full bg-green-400 animate-pulse" />
          Sales Automation and Distribution Management System
        </div>

        {/* Name */}
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-3 leading-tight tracking-tight">
          Dipta{' '}
          <span
            style={{
        ...
        {/* Title */}
        <h2 className="text-xl md:text-2xl lg:text-3xl font-semibold mb-5 text-blue-100 tracking-wide">
          Digital Transformation Professional
        </h2>

        {/* Description */}
        <p className="max-w-4xl mx-auto text-base md:text-lg lg:text-xl text-blue-100/90 mb-8 leading-relaxed px-2 md:px-6">
        ...
        {/* CTA Buttons */}
        <div className="flex flex-row items-center justify-center gap-4 mb-8 w-full max-w-md md:max-w-none">
          <a
            href="/resume.pdf"
